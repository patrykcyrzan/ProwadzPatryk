...
import pl.cyrzan.prowadzpatryk.di.component.ActivityComponent;
import pl.cyrzan.prowadzpatryk.di.component.ConfigPersistentComponent;
import pl.cyrzan.prowadzpatryk.di.component.DaggerConfigPersistentComponent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sComponentsArray.get(mActivityId) == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .applicationComponent(ProwadzPatrykApplication.get(this).getComponent())
                    .build();
